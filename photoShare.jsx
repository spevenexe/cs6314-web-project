...
function UserPhotosRoute({ setContext, advancedFeatures, setAdvancedFeatures }) {
  const { userId, photoId } = useParams();
  return <UserPhotos userId={userId} photoId={photoId} setContext={setContext} advancedFeatures={advancedFeatures} setAdvancedFeatures={setAdvancedFeatures} />;
}

function UserCommentsRoute({setContext, advancedFeatures, setAdvancedFeatures}) {
  const { userId } = useParams();
  return <UserComments userId={userId} setContext={setContext} advancedFeatures={advancedFeatures} setAdvancedFeatures={setAdvancedFeatures}/>;
}
              ...
              <Routes>
                ...
                // for "Advanced Features" photos are indexed by their ids, rather than a incremental index
                  ...
                  element={(
                    <UserPhotosRoute
                      setContext={setContext}
                      advancedFeatures={advancedFeatures} setAdvancedFeatures={setAdvancedFeatures}
                    />
                  )}
                />
