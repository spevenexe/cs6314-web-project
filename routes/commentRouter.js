...
import { getComments, postComment, getPhotosByMention, deleteComment, getMentions } from "../controllers/commentController.js";
...
// get mentions of a given user
commentRouter.get('/mentions/:id', isAuthenticated, getMentions);
